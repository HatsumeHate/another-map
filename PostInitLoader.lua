do
	...
	function InitGlobals()
		...
		TimerStart(CreateTimer(), 3., false, function()
			ThrowMissile(gg_unit_HBRB_0005, nil, 'M001', nil, GetUnitX(gg_unit_HBRB_0005), GetUnitY(gg_unit_HBRB_0005), GetUnitX(gg_unit_HSRC_0004), GetUnitY(gg_unit_HSRC_0004), 0.)
