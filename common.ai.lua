...
--==================================================================================================
---@param str string
function DebugS(str) end

---@param str string
---@param val integer
function DebugFI(str, val) end

---@param str string
---@param val integer
function DebugUnitID(str, val) end

---@param p integer
---@param str string
function DisplayText(p, str) end

---@param p integer
---@param str string
---@param val integer
function DisplayTextI(p, str, val) end

---@param p integer
---@param str string
---@param v1 integer
---@param v2 integer
function DisplayTextII(p, str, v1, v2) end
...
---@param v2 integer
---@param v3 integer
function DisplayTextIII(p, str, v1, v2, v3) end

---@return boolean
function DoAiScriptDebug() end

---@return integer
function GetAiPlayer() end

---@return integer
function GetHeroId() end

---@return integer
function GetHeroLevelAI() end

---@param unitid integer
---@return integer
function GetUnitCount(unitid) end

---@param p player
---@param unitid integer
---@return integer
function GetPlayerUnitTypeCount(p, unitid) end

---@param unitid integer
---@return integer
function GetUnitCountDone(unitid) end

---@param id integer
---@param tn integer
---@param dn boolean
---@return integer
function GetTownUnitCount(id, tn, dn) end
...
---@param unitid integer
---@return integer
function GetUnitWoodCost(unitid) end

---@param unitid integer
---@return integer
function GetUnitBuildTime(unitid) end

---@return integer
function GetMinesOwned() end

---@return integer
function GetGoldOwned() end

---@return integer
function TownWithMine() end

---@param townid integer
---@return boolean
function TownHasMine(townid) end

---@param townid integer
---@return boolean
function TownHasHall(townid) end

---@param id integer
---@return integer
function GetUpgradeLevel(id) end

---@param id integer
---@return integer
function GetUpgradeGoldCost(id) end

---@param id integer
---@return integer
function GetUpgradeWoodCost(id) end

---@return integer
function GetNextExpansion() end

---@return unit
function GetMegaTarget() end

---@param p player
---@return unit
function GetBuilding(p) end

---@return integer
function GetEnemyPower() end

---@param id unit
function SetAllianceTarget(id) end

---@return unit
function GetAllianceTarget() end

---@param qty integer
---@param id integer
---@param town integer
---@return boolean
function SetProduce(qty, id, town) end

---@param unitid unit
function Unsummon(unitid) end

---@param peon unit
---@param id integer
---@return boolean
function SetExpansion(peon, id) end

---@param id integer
---@return boolean
function SetUpgrade(id) end

---@param func code
function SetHeroLevels(func) end

---@param state boolean
function SetNewHeroes(state) end

function PurchaseZeppelin() end
...
---@param make integer
---@return boolean
function MergeUnits(qty, a, b, make) end

---@param qty integer
---@param id integer
---@return boolean
function ConvertUnits(qty, id) end

function SetCampaignAI() end

function SetMeleeAI() end

---@param state boolean
function SetTargetHeroes(state) end

---@param state boolean
function SetPeonsRepair(state) end

---@param state boolean
function SetRandomPaths(state) end

---@param state boolean
function SetDefendPlayer(state) end

---@param state boolean
function SetHeroesFlee(state) end

---@param state boolean
function SetHeroesBuyItems(state) end

---@param state boolean
function SetWatchMegaTargets(state) end

---@param state boolean
function SetIgnoreInjured(state) end

---@param state boolean
function SetHeroesTakeItems(state) end

---@param state boolean
function SetUnitsFlee(state) end

---@param state boolean
function SetGroupsFlee(state) end

---@param state boolean
function SetSlowChopping(state) end

---@param allow boolean
function SetCaptainChanges(allow) end

---@param state boolean
function SetSmartArtillery(state) end

---@param qty integer
function SetReplacementCount(qty) end

---@param allow boolean
function GroupTimedLife(allow) end

function RemoveInjuries() end

function RemoveSiege() end

function InitAssault() end

---@param qty integer
---@param id integer
---@return boolean
function AddAssault(qty, id) end

---@param qty integer
---@param id integer
---@return boolean
function AddDefenders(qty, id) end

---@param min integer
---@param max integer
---@param flyers boolean
---@return unit
function GetCreepCamp(min, max, flyers_ok) end

function StartGetEnemyBase() end

---@return boolean
function WaitGetEnemyBase() end

---@return unit
function GetEnemyBase() end

---@return unit
function GetExpansionFoe() end

---@return unit
function GetEnemyExpansion() end

---@return integer
function GetExpansionX() end

---@return integer
function GetExpansionY() end

---@param x real
---@param y real
function SetStagePoint(x, y) end

---@param target unit
function AttackMoveKill(target) end

---@param x integer
---@param y integer
function AttackMoveXY(x, y) end

---@param x integer
---@param y integer
function LoadZepWave(x, y) end

---@param id player
---@param check boolean
---@return boolean
function SuicidePlayer(id, check_full) end

---@param id player
---@param check boolean
---@return boolean
function SuicidePlayerUnits(id, check_full) end

---@param attack boolean
---@return boolean
function CaptainInCombat(attack_captain) end

---@param target unit
---@return boolean
function IsTowered(target) end

function ClearHarvestAI() end

---@param town integer
---@param peons integer
function HarvestGold(town, peons) end

---@param town integer
---@param peons integer
function HarvestWood(town, peons) end

---@return unit
function GetExpansionPeon() end

function StopGathering() end

---@param id integer
---@param x real
---@param y real
function AddGuardPost(id, x, y) end

function FillGuardPosts() end

function ReturnGuardPosts() end

function CreateCaptains() end

---@param which integer
---@param x real
---@param y real
function SetCaptainHome(which, x, y) end

function ResetCaptainLocs() end

---@param x real
---@param y real
function ShiftTownSpot(x, y) end

---@param x real
---@param y real
function TeleportCaptain(x, y) end

function ClearCaptainTargets() end

---@param x real
---@param y real
function CaptainAttack(x, y) end

---@param id player
function CaptainVsUnits(id) end

---@param id player
function CaptainVsPlayer(id) end

function CaptainGoHome() end

---@return boolean
function CaptainIsHome() end

---@return boolean
function CaptainIsFull() end

---@return boolean
function CaptainIsEmpty() end

---@return integer
function CaptainGroupSize() end

---@return integer
function CaptainReadiness() end

---@return boolean
function CaptainRetreating() end

---@return integer
function CaptainReadinessHP() end

---@return integer
function CaptainReadinessMa() end

---@return boolean
function CaptainAtGoal() end

---@return boolean
function CreepsOnMap() end

---@param count integer
---@param unitid integer
function SuicideUnit(count, unitid) end

---@param ct integer
---@param uid integer
---@param pid integer
function SuicideUnitEx(ct, uid, pid) end

---@param func code
function StartThread(func) end
...
---@param id unit
---@return boolean
function UnitAlive(id) end

---@param id unit
---@return boolean
function UnitInvis(id) end

---@param unitid integer
---@return integer
function IgnoredUnits(unitid) end

---@return boolean
function TownThreatened() end

function DisablePathing() end

function SetAmphibious() end

---@return integer
function CommandsWaiting() end

---@return integer
function GetLastCommand() end

---@return integer
function GetLastData() end

function PopLastCommand() end

---@return integer
function MeleeDifficulty() end
...
function StandardAI(heroes, peons, attacks)
	...
	---@type boolean
	isNewbie = (MeleeDifficulty() == MELEE_NEWBIE)
...
function TownCountEx(unitid, only_done, townid)
	...
	---@type integer
	have_qty = GetUnitCountEx(unitid, only_done, townid)
...
function CreepAttackEx()
	---@type unit
	target = GetCreepCamp(min_creeps, max_creeps, allow_air_creeps)
	SetAllianceTarget(target)
	FormGroup(3, true)
	AttackMoveKillA(target)
end
...
function CampaignBasicsA()
	---@type integer
	food_each = GetFoodMade(racial_farm)
	---@type integer
	on_wood   = nil
