    ...
    function InitLocaleLibrary()
        ...
        LOCALE_LIST = {
            ["ruRU"] = {
                ...
                PLAYER_PROGRESSION_MSG_2 = " уровня волны.",
                ...
                ITEM_LEG_DESCRIPTION_WITCH_MASTERY = "Каждое произнесенное заклинание увеличивает силу магии на 10%% в течение 10 секунд, однако взамен пожирает 5%% здоровья",
                ...
                [FourCC("A010")] = {
                    [1] = "Варвар образует яростный вихрь безумно вращаясь, нанося @e!EWHW.dmg# типа @e!EWHW.atr# 3 раза в секунду вокруг себя. При этом постоянно потребляется 9 маны в сек, а скорость передвижения снижается на 25%%.",
                },
                [FourCC("A00Q")] = {
                ...
                [FourCC("ABFA")] = {
                    [1] = "Дает укрепление на @b!A01N.eh# от максимального здоровья и исцеляет на @e!EFAA.hp_perc# каждую секунду и дает @b!A01N.va1# @b!A01N.pa1# в течение @b!A01N.time# секунд.",
                    [10] = "Дает укрепление на @b!A01N.eh# от максимального здоровья и исцеляет на @e!EFAA.hp_perc# каждую секунду и дает @b!A01N.va1# @b!A01N.pa1# и @b!A01N.va2# @b!A01N.pa2# в течение @b!A01N.time# секунд .",
                },
                [FourCC("ADBS")] = {
                ...
                [FourCC("ABCA")] = {
                    [1] = "Призыв двух древних воинов, которые атакуют врагов и получают урон. Они наследуют 70%% ваших характеристик. С повышением уровня умения увеличивается их время существования."
                },
                [FourCC("A00I")] = {
                ...
                [FourCC("APRT")] = {
                    [1] = "В течение @b!A03K.time# секунд Паладин в ближнем бою атакует в ответ нанося @e!retribution_effect.dmg# as @e!retribution_effect.atr#.",
                },
            ...
            ["enUS"] = {
                ...
                PLAYER_PROGRESSION_MSG_2 = " in all time.",
                ...
                GIFT_HEARTH_OF_GHOR_DESC = "Monsters with a chance gain 5%% of attack|nand move speed up to 25%%.|nGold aquired is increased by 15%%.|nSkips 1 level each wave.|nDuration is 3 waves.",
                ...
                ITEM_LEG_DESCRIPTION_WITCH_MASTERY = "Each cast spell will increase your spell power by 10%% in exhange of 5%% life for 10 seconds",
                ...
                [FourCC("ABWC")] = {
                    [1] = "Barbarian screams in @e!EWCR.aoe# range, which reduces enemy attack by @b!A00Y.va1# and movement speed by @b!A00Y.va3# for @b!A00Y.time# seconds.",
                },
                [FourCC("ABRC")] = {
                ...
                [FourCC("A00A")] = {
                    [1] = "Throws chains which fly up to @s!A00A.rng# range, pulling every target they hit to you. After that, targets loses @b!ACHA.pa1# by @b!ACHA.va1#, @b!ACHA.pa2# by @b!ACHA.va2#, @b!ACHA.pa3# by @b!ACHA.va3# and @b!ACHA.pa4# by @b!ACHA.va4# for @b!ACHA.time# seconds.",
                },
                [FourCC("A010")] = {
                ...
                [FourCC("ABFA")] = {
                    ...
                    [10] = "Provides endurance of @b!A01N.eh# from max hp and heals you for @e!EFAA.hp_perc# every second and gives @b!A01N.va1# @b!A01N.pa1# and @b!A01N.va2# @b!A01N.pa2# during @b!A01N.time# seconds.",
                },
                [FourCC("ADBS")] = {
                    [1] = "Two swift strikes that reset your attack status and deal @e!effect_double_strike.dmg# as @e!effect_double_strike.atr# per hit."
                },
                [FourCC("ABRV")] = {
                ...
                [FourCC("ABCA")] = {
                    [1] = "Summon 2 ancient warriors which attack enemies with cleave and take damage. They inherit 70%% of your stats. Increasing the level of this skill enhances theirs summon duration."
                },
                [FourCC("A00I")] = {
                ...
                [FourCC("ANBK")] = {
                    [1] = "Summons bones around a point from the ground, which deals damage to every enemy caught by @e!ENBK.pwr# as @e!ENBK.atr#.",
                },
                [FourCC("ANFD")] = {
                ...
                [FourCC("AABA")] = {
                    [1] = "Deal @e!effect_backstab.dmg# as @e!effect_backstab.atr# damage in front. Attacking to the side of an enemy boosts power by 50%%, while attacking to the back boosts power by 100%%.",
                },
                [FourCC("AASH")] = {
                    [1] = "Throws 3 shurikens, each deals @e!effect_shuriken.dmg# as @e!effect_shuriken.atr#. The skill has additional 15%% crit chance.",
                },
                [FourCC("AAEV")] = {
                    [1] = "3 lunging attacks which deal @e!effect_eviscerate.dmg# as @e!effect_eviscerate.atr# in front. Next lunge in the combo is stronger by 25%%.",
                },
                [FourCC("AAVB")] = {
                    [1] = "Poison strike that deals @e!effect_viper_bite.dmg# as @e!effect_viper_bite.atr# in front, a poison power is @e!effect_viper_bite_periodic.dmg# as @e!effect_viper_bite_periodic.atr# and slows enemies down by @b!ABVP.va1# for @b!ABVP.time#.",
                },
                [FourCC("AABF")] = {
                ...
                [FourCC("AASB")] = {
                    [1] = "Throws a smoke bomb that blinds all enemies in @e!smoke_bomb_effect.aoe# raduis and reduces their cast speed by @b!ABSB.va1# for @b!ABSB.time#.",
                },
                [FourCC("AARL")] = {
                ...
                [FourCC("APFH")] = {
                    [1] = "Calls down a punishment from heaven dealing @e!fist_of_heavens_effect.pwr# as @e!fist_of_heavens_effect.atr#.",
                },
                [FourCC("APVA")] = {
                ...
                TALENTS = {
                    ...
                    ["talent_second_wind"] = {
                        name = "Second wind",
                        [1] = "Taking fatal damage removes all negative effects and converts your mana %% into health %%. Also increases your attack and move speed by 25%% for 15 seconds. Can happen once in 2 mins.",
                    },
                    ["talent_leeches"] = {
                        name = "Leeches",
