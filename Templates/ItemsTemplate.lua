...
do
    ...
    SOUNDPACK_POTION = 28; SOUNDPACK_SCROLL = 29; SOUNDPACK_GEM = 30; SOUNDPACK_BOOK = 31; SOUNDPACK_RUNE = 32; SOUNDPACK_CHARM = 33; SOUNDPACK_KEY = 34
    ...
    function DefineItemsData()
		...
		CLASS_SKILL_LIST = {
			...
			[SORCERESS_CLASS] = {
				...
				[SKILL_CATEGORY_FIRE] 				= { "A00D", "A00F", "A00I", "AMLT", "AFRW", "ASFS", "AFWL", "ASEF", "AFCR", "ASRF" },
		...
		ITEM_SOUNDPACK = {
			...
			[SOUNDPACK_KEY] 				 = { drop = "Sound\\key.wav" },
		...
		ItemAddData('I046', {
			NAME    = LOCALE_LIST[my_locale].STARTING_ITEM_NAME_BOW,
			TYPE = ITEM_TYPE_WEAPON,
			SUBTYPE = BOW_WEAPON,
			DAMAGE  = 30,
			stat_modificator = 1.45,
			QUALITY = COMMON_ITEM,
			model = "Items\\Weapon_Bow_1.mdx",
			frame_texture = "Weapons\\BTNRoughwoodBow.blp",
			flippy = true,
			BONUS   = {
				{ PARAM = ATTACK_SPEED, VALUE = 3, METHOD = STRAIGHT_BONUS },
				{ PARAM = CRIT_CHANCE, VALUE = 3, METHOD = STRAIGHT_BONUS },
			},
			MAX_SLOTS = 0,
			sell_value = 45,
		...
		ItemAddData('I00B', {
			...
			point_bonus 	   = {
				...
				[ITEM_TYPE_ARMOR]  		= {  PARAM = MAGICAL_SUPPRESSION, VALUE = 1.06, METHOD = MULTIPLY_BONUS },
		...
		ItemAddData('I002', {
			...
			point_bonus 	   = {
				...
				[ITEM_TYPE_ARMOR]  		= {  PARAM = PHYSICAL_DEFENCE, VALUE = 1.06, METHOD = MULTIPLY_BONUS },
		...
		ItemAddData('I00A', {
			...
			point_bonus 	   = {
				[ITEM_TYPE_WEAPON] 		= {  PARAM = PHYSICAL_ATTACK, VALUE = 25, METHOD = STRAIGHT_BONUS },
		...
		ItemAddData('I00J', {
			...
			point_bonus 	   = {
				[ITEM_TYPE_WEAPON] 		= {  PARAM = MAGICAL_ATTACK, VALUE = 33, METHOD = STRAIGHT_BONUS },
		...
		ItemAddData('I055', {
			...
			TYPE    		   = ITEM_TYPE_CONSUMABLE,
			QUALITY 		   = RARE_ITEM,
			frame_texture      = "ReplaceableTextures\\CommandButtons\\BTNLesserInvisibility.blp",
			item_description   = LOCALE_LIST[my_locale].ASHEN_TONIC_DESC_TEXT,
			soundpack = ITEM_SOUNDPACK[SOUNDPACK_POTION],
			cost = 100,
			cooldown_type = 7,
			usable = true
		...
		ItemAddData('I03E', {
			...
			TYPE    		   	= ITEM_TYPE_SKILLBOOK,
			frame_texture      	= "Items\\Book\\BTNLockedTome.BLP",
			item_description 	= LOCALE_LIST[my_locale].SKILLBOOK_TEXT,
		...
		ItemAddData('I044', {
			NAME    		   	= LOCALE_LIST[my_locale].SKILLBOOK_BOW,
			TYPE    		   	= ITEM_TYPE_SKILLBOOK,
			frame_texture      	= "Items\\Book\\BTNbookAzyr.blp",
			item_description 	= LOCALE_LIST[my_locale].SKILLBOOK_TEXT,
			restricted_to 		= ASSASSIN_CLASS,
			skill_category 		= CLASS_SKILL_LIST[ASSASSIN_CLASS][SKILL_CATEGORY_BOW],
			learn_effect		= "Abilities\\Spells\\Items\\AIsm\\AIsmTarget.mdx",
			soundpack 			= ITEM_SOUNDPACK[SOUNDPACK_BOOK],
			cost 				= 200,
			sell_penalty 		= 0.5
		...
		ItemAddData('I03G', {
			...
			TYPE    		   	= ITEM_TYPE_SKILLBOOK,
			frame_texture      	= "Items\\Book\\BTN_cr_RunicTOME.blp",
			item_description 	= LOCALE_LIST[my_locale].SKILLBOOK_TEXT,
			restricted_to 		= ASSASSIN_CLASS,
		...
		ItemAddData('rd01', {
			NAME    		   	= LOCALE_LIST[my_locale].RANDOM_AMULET,
			TYPE    		   	= ITEM_TYPE_OTHER,
			QUALITY 		   	= COMMON_ITEM,
			SUBTYPE 			= NECKLACE_JEWELRY,
			frame_texture      	= "UI\\BTNunknown_amulet.blp",
			item_description 	= LOCALE_LIST[my_locale].RANDOM_STATS_DESC,
			cost 				= 1000,
			sell_penalty 		= 0.5,
			sellable 			= false,
			droppable 			= false,
		...
		ItemAddData('rd02', {
			NAME    		   	= LOCALE_LIST[my_locale].RANDOM_RING,
			TYPE    		   	= ITEM_TYPE_OTHER,
			QUALITY 		   	= COMMON_ITEM,
			SUBTYPE 			= RING_JEWELRY,
			frame_texture      	= "UI\\BTNunknown_ring.blp",
			item_description 	= LOCALE_LIST[my_locale].RANDOM_STATS_DESC,
			cost 				= 1000,
			sell_penalty 		= 0.5,
			sellable 			= false,
		...
		ItemAddData('rd03', {
			NAME    		   	= LOCALE_LIST[my_locale].RANDOM_SWORD,
			TYPE    		   	= ITEM_TYPE_OTHER,
			QUALITY 		   	= COMMON_ITEM,
			SUBTYPE 			= SWORD_WEAPON,
			frame_texture      	= "UI\\BTNunknown_sword.blp",
			item_description 	= LOCALE_LIST[my_locale].RANDOM_STATS_DESC,
			cost 				= 1000,
			sell_penalty 		= 0.5,
			sellable 			= false,
		...
		ItemAddData('rd04', {
			NAME    		   	= LOCALE_LIST[my_locale].RANDOM_SWORD2H,
			TYPE    		   	= ITEM_TYPE_OTHER,
			QUALITY 		   	= COMMON_ITEM,
			SUBTYPE 			= GREATSWORD_WEAPON,
			frame_texture      	= "UI\\BTNunknown_greatsword.blp",
			item_description 	= LOCALE_LIST[my_locale].RANDOM_STATS_DESC,
			cost 				= 1000,
			sell_penalty 		= 0.5,
			sellable 			= false,
		...
		ItemAddData('rd05', {
			NAME    		   	= LOCALE_LIST[my_locale].RANDOM_AXE,
			TYPE    		   	= ITEM_TYPE_OTHER,
			QUALITY 		   	= COMMON_ITEM,
			SUBTYPE 			= AXE_WEAPON,
			frame_texture      	= "UI\\BTNunknown_axe.blp",
			item_description 	= LOCALE_LIST[my_locale].RANDOM_STATS_DESC,
			cost 				= 1000,
			sell_penalty 		= 0.5,
			sellable 			= false,
		...
		ItemAddData('rd06', {
			NAME    		   	= LOCALE_LIST[my_locale].RANDOM_AXE2H,
			TYPE    		   	= ITEM_TYPE_OTHER,
			QUALITY 		   	= COMMON_ITEM,
			SUBTYPE 			= GREATAXE_WEAPON,
			frame_texture      	= "UI\\BTNunknown_greataxe.blp",
			item_description 	= LOCALE_LIST[my_locale].RANDOM_STATS_DESC,
			cost 				= 1000,
			sell_penalty 		= 0.5,
			sellable 			= false,
		...
		ItemAddData('rd07', {
			NAME    		   	= LOCALE_LIST[my_locale].RANDOM_BLUNT,
			TYPE    		   	= ITEM_TYPE_OTHER,
			QUALITY 		   	= COMMON_ITEM,
			SUBTYPE 			= BLUNT_WEAPON,
			frame_texture      	= "UI\\BTNunknown_hammer.blp",
			item_description 	= LOCALE_LIST[my_locale].RANDOM_STATS_DESC,
			cost 				= 1000,
			sell_penalty 		= 0.5,
			sellable 			= false,
		...
		ItemAddData('rd08', {
			NAME    		   	= LOCALE_LIST[my_locale].RANDOM_BLUNT2H,
			TYPE    		   	= ITEM_TYPE_OTHER,
			QUALITY 		   	= COMMON_ITEM,
			SUBTYPE 			= GREATBLUNT_WEAPON,
			frame_texture      	= "UI\\BTNunknown_greathammer.blp",
			item_description 	= LOCALE_LIST[my_locale].RANDOM_STATS_DESC,
			cost 				= 1000,
			sell_penalty 		= 0.5,
			sellable 			= false,
		...
		ItemAddData('rd09', {
			NAME    		   	= LOCALE_LIST[my_locale].RANDOM_DAGGER,
			TYPE    		   	= ITEM_TYPE_OTHER,
			QUALITY 		   	= COMMON_ITEM,
			SUBTYPE 			= DAGGER_WEAPON,
			frame_texture      	= "UI\\BTNunknown_dagger.blp",
			item_description 	= LOCALE_LIST[my_locale].RANDOM_STATS_DESC,
			cost 				= 1000,
			sell_penalty 		= 0.5,
			sellable 			= false,
		...
		ItemAddData('rd10', {
			NAME    		   	= LOCALE_LIST[my_locale].RANDOM_STAFF,
			TYPE    		   	= ITEM_TYPE_OTHER,
			QUALITY 		   	= COMMON_ITEM,
			SUBTYPE 			= STAFF_WEAPON,
			frame_texture      	= "UI\\BTNunknown_staff.blp",
			item_description 	= LOCALE_LIST[my_locale].RANDOM_STATS_DESC,
			cost 				= 1000,
			sell_penalty 		= 0.5,
			sellable 			= false,
		...
		ItemAddData('rd11', {
			NAME    		   	= LOCALE_LIST[my_locale].RANDOM_BOW,
			TYPE    		   	= ITEM_TYPE_OTHER,
			QUALITY 		   	= COMMON_ITEM,
			SUBTYPE 			= BOW_WEAPON,
			frame_texture      	= "UI\\BTNunknown_bow.blp",
			item_description 	= LOCALE_LIST[my_locale].RANDOM_STATS_DESC,
			cost 				= 1000,
			sell_penalty 		= 0.5,
			sellable 			= false,
		...
		ItemAddData('rd12', {
			NAME    		   	= LOCALE_LIST[my_locale].RANDOM_BELT,
			TYPE    		   	= ITEM_TYPE_OTHER,
			QUALITY 		   	= COMMON_ITEM,
			SUBTYPE 			= BELT_ARMOR,
			frame_texture      	= "UI\\BTNunknown_belt.blp",
			item_description 	= LOCALE_LIST[my_locale].RANDOM_STATS_DESC,
			cost 				= 1000,
			sell_penalty 		= 0.5,
			sellable 			= false,
		...
		ItemAddData('rd14', {
			NAME    		   	= LOCALE_LIST[my_locale].RANDOM_BOOTS,
			TYPE    		   	= ITEM_TYPE_OTHER,
			QUALITY 		   	= COMMON_ITEM,
			SUBTYPE 			= LEGS_ARMOR,
			frame_texture      	= "UI\\BTNunknown_boots.blp",
			item_description 	= LOCALE_LIST[my_locale].RANDOM_STATS_DESC,
			cost 				= 1000,
			sell_penalty 		= 0.5,
			sellable 			= false,
		...
		ItemAddData('rd15', {
			NAME    		   	= LOCALE_LIST[my_locale].RANDOM_CHEST,
			TYPE    		   	= ITEM_TYPE_OTHER,
			QUALITY 		   	= COMMON_ITEM,
			SUBTYPE 			= CHEST_ARMOR,
			frame_texture      	= "UI\\BTNunknown_chest.blp",
			item_description 	= LOCALE_LIST[my_locale].RANDOM_STATS_DESC,
			cost 				= 1000,
			sell_penalty 		= 0.5,
			sellable 			= false,
		...
		ItemAddData('rd16', {
			NAME    		   	= LOCALE_LIST[my_locale].RANDOM_GLOVES,
			TYPE    		   	= ITEM_TYPE_OTHER,
			QUALITY 		   	= COMMON_ITEM,
			SUBTYPE 			= HANDS_ARMOR,
			frame_texture      	= "UI\\BTNunknown_gloves.blp",
			item_description 	= LOCALE_LIST[my_locale].RANDOM_STATS_DESC,
			cost 				= 1000,
			sell_penalty 		= 0.5,
			sellable 			= false,
		...
		ItemAddData('rd17', {
			NAME    		   	= LOCALE_LIST[my_locale].RANDOM_HELMET,
			TYPE    		   	= ITEM_TYPE_OTHER,
			QUALITY 		   	= COMMON_ITEM,
			SUBTYPE 			= HEAD_ARMOR,
			frame_texture      	= "UI\\BTNunknown_helmet.blp",
			item_description 	= LOCALE_LIST[my_locale].RANDOM_STATS_DESC,
			cost 				= 1000,
			sell_penalty 		= 0.5,
			sellable 			= false,
		...
		ItemAddData('rd18', {
			NAME    		   	= LOCALE_LIST[my_locale].RANDOM_ORB,
			TYPE    		   	= ITEM_TYPE_OTHER,
			QUALITY 		   	= COMMON_ITEM,
			SUBTYPE 			= ORB_OFFHAND,
			frame_texture      	= "UI\\BTNunknown_orb.blp",
			item_description 	= LOCALE_LIST[my_locale].RANDOM_STATS_DESC,
			cost 				= 1000,
			sell_penalty 		= 0.5,
			sellable 			= false,
		...
		ItemAddData('rd19', {
			NAME    		   	= LOCALE_LIST[my_locale].RANDOM_QUIVER,
			TYPE    		   	= ITEM_TYPE_OTHER,
			QUALITY 		   	= COMMON_ITEM,
			SUBTYPE 			= QUIVER_OFFHAND,
			frame_texture      	= "UI\\BTNunknown_quiver.blp",
			item_description 	= LOCALE_LIST[my_locale].RANDOM_STATS_DESC,
			cost 				= 1000,
			sell_penalty 		= 0.5,
			sellable 			= false,
		...
		ItemAddData('rd13', {
			NAME    		   	= LOCALE_LIST[my_locale].RANDOM_SHIELD,
			TYPE    		   	= ITEM_TYPE_OTHER,
			QUALITY 		   	= COMMON_ITEM,
			SUBTYPE 			= SHIELD_OFFHAND,
			frame_texture      	= "UI\\BTNunknown_shield.blp",
			item_description 	= LOCALE_LIST[my_locale].RANDOM_STATS_DESC,
			cost 				= 1000,
			sell_penalty 		= 0.5,
			sellable 			= false,
		...
		ItemAddData('I00N', {
			...
			level = 5,
			flippy = true,
			frame_texture = "Weapons\\BTNbow5.blp",
			model = "Items\\Windforce.mdx",
			special_description = "\"".. LOCALE_LIST[my_locale].ITEM_SPEC_DESCRIPTION_RAT_HUNTER .."\"",
			BONUS   = {
				{ PARAM = PHYSICAL_ATTACK, VALUE = 20, METHOD = STRAIGHT_BONUS, base = 20, delta = 1, delta_level = 1, delta_level_max = 45 },
		...
		ItemAddData('I01L', {
			NAME    = LOCALE_LIST[my_locale].ITEM_NAME_NIGHTWATCH,
			TYPE    = ITEM_TYPE_ARMOR,
			SUBTYPE = HEAD_ARMOR,
			QUALITY = UNIQUE_ITEM,
			DEFENCE = 30,
			...
			level = 10,
			BONUS   = {
				{ PARAM = DODGE_CHANCE, VALUE = 12, METHOD = STRAIGHT_BONUS },
			...
			special_description = "\"".. LOCALE_LIST[my_locale].ITEM_SPEC_DESCRIPTION_NIGHTWATCH .."\"",
			soundpack = ITEM_SOUNDPACK[SOUNDPACK_HEAD_LIGHT_ARMOR],
		})
		...
		ItemAddData('I01F', {
			...
			assassin_texture = TEXTURE_ID_ASSASSIN_ARMOR_24,
		...
		ItemAddData('I02I', {
			...
			assassin_texture = TEXTURE_ID_ASSASSIN_ARMOR_32,
		...
		ItemAddData('I02X', {
			...
			BONUS   = {
				...
				{ PARAM = RESOURCE_GENERATION, VALUE = 25, METHOD = STRAIGHT_BONUS },
			},
			MAX_SLOTS = 3,
		...
		ItemAddData('I03U', {
			...
			texture = TEXTURE_ID_ARMOR_02,
			assassin_texture = TEXTURE_ID_ASSASSIN_ARMOR_17,
		...
		ItemAddData('I03Y', {
			...
			soundpack = { equip = "Sound\\ring_secondchance_equip.wav", uneqip = "Sound\\ring_unequip.wav", drop = "Sound\\ring.wav" },
		})
		...
		ItemAddData('I042', {
			...
			BONUS   = {
				...
				{ PARAM = HP_VALUE, VALUE = 74, METHOD = STRAIGHT_BONUS, base = 74, delta = 1, delta_level = 1, delta_level_max = 50  },
				{ PARAM = HP_PER_HIT, VALUE = 5, METHOD = STRAIGHT_BONUS, base = 5, delta = 1, delta_level = 5, delta_level_max = 10 },
				{ PARAM = BLEEDING_DAMAGE_BOOST, VALUE = 20, METHOD = STRAIGHT_BONUS },
			},
			legendary_effect = GetLegendaryEffect("open_wound_effect"),
			...
			soundpack = { equip = "Sound\\sword_souldrinker_equip.wav", unequip = "Sound\\sword_unequip.wav", drop = "Sound\\largemetalweapon.wav" }
		})


		ItemAddData('I043', {
			NAME    = LOCALE_LIST[my_locale].ITEM_NAME_GROUNDER,
			TYPE    = ITEM_TYPE_WEAPON,
			SUBTYPE = GREATBLUNT_WEAPON,
			ATTRIBUTE = PHYSICAL_ATTRIBUTE,
			QUALITY = UNIQUE_ITEM,
			DAMAGE  = 50,
			stat_modificator = 1.9,
			flippy = true,
			level = 10,
			BONUS   = {
				{ PARAM = STR_STAT, VALUE = 14, METHOD = STRAIGHT_BONUS, base = 14, delta = 1, delta_level = 1, delta_level_max = 50 },
				{ PARAM = DAMAGE_TO_CC_ENEMIES, VALUE = 50, METHOD = STRAIGHT_BONUS },
				{ PARAM = MAGICAL_SUPPRESSION, VALUE = 1.14, METHOD = MULTIPLY_BONUS},
			},
			legendary_effect = GetLegendaryEffect("grounder_effect_Legendary"),
			MAX_SLOTS = 3,
			frame_texture = "Weapons\\BTNNatureHammer.blp",
			model = "Items\\GroveKeeperHammer.mdx",
			special_description = "\"".. LOCALE_LIST[my_locale].ITEM_SPEC_DESCRIPTION_GROUNDER .."\"",
			soundpack = { equip = "Sound\\staff_equip.wav", unequip = "Sound\\staff_unequip.wav", drop = "Sound\\largemetalweapon.wav" }
		})

		ItemAddData('I047', {
			NAME    = LOCALE_LIST[my_locale].ITEM_NAME_INFINITY_CHAIN,
			TYPE    = ITEM_TYPE_ARMOR,
			SUBTYPE = HANDS_ARMOR,
			QUALITY = UNIQUE_ITEM,
			stat_modificator = 1.12,
			...
			level = 10,
			BONUS   = {
				{ PARAM = LIGHTNING_BONUS, VALUE = 10, METHOD = STRAIGHT_BONUS, base = 10, delta = 1, delta_level = 10, delta_level_max = 5 },
				{ PARAM = INT_STAT, VALUE = 6, METHOD = STRAIGHT_BONUS, base = 6, delta = 1, delta_level = 5, delta_level_max = 10 },
				{ PARAM = CAST_SPEED, VALUE = 12, METHOD = STRAIGHT_BONUS },
			},
			SKILL_BONUS = { { id = "A019", bonus_levels = 5 } },
			MAX_SLOTS = 2,
			frame_texture = "Armor\\BTNWind Glove.blp",
			legendary_effect = GetLegendaryEffect("infinity_chain_effect_Legendary"),
			special_description = "\"".. LOCALE_LIST[my_locale].ITEM_SPEC_DESCRIPTION_INFINITY_CHAIN .."\"",
			soundpack = ITEM_SOUNDPACK[SOUNDPACK_HANDS_MID_ARMOR],
		})
		...
		ItemAddData('I04M', {
			...
			level = 10,
			BONUS = {
				{ PARAM = ALL_RESIST, VALUE = 7, METHOD = STRAIGHT_BONUS, base = 7, delta = 1, delta_level = 5, delta_level_max = 10 },
				{ PARAM = PHYSICAL_ATTACK, VALUE = 15, METHOD = STRAIGHT_BONUS, base = 15, delta = 1, delta_level = 2, delta_level_max = 15 },
				{ PARAM = MAGICAL_SUPPRESSION, VALUE = 45, METHOD = STRAIGHT_BONUS, base = 45, delta = 2, delta_level = 1, delta_level_max = 50 },
			},
			MAX_SLOTS = 3,
			SKILL_BONUS = { { id = "AAST", bonus_levels = 5 } },
			frame_texture = "Armor\\BTNMShoesoftheMagi.blp",
			legendary_effect =  GetLegendaryEffect("nightwalkers_effect_Legendary"),
			special_description = "\"".. LOCALE_LIST[my_locale].ITEM_SPEC_DESCRIPTION_NIGHTWALKERS .."\"",
			soundpack = ITEM_SOUNDPACK[SOUNDPACK_BOOTS_MID_ARMOR],
		})

		ItemAddData('I04N', {
			NAME    = LOCALE_LIST[my_locale].ITEM_NAME_GALACOS_TRICK,
			TYPE    = ITEM_TYPE_ARMOR,
			SUBTYPE = HANDS_ARMOR,
			QUALITY = UNIQUE_ITEM,
			stat_modificator = 1.,
			...
			level = 10,
			BONUS   = {
				{ PARAM = DAMAGE_TO_CC_ENEMIES, VALUE = 20, METHOD = STRAIGHT_BONUS },
				{ PARAM = CONTROL_DURATION, VALUE = 25, METHOD = STRAIGHT_BONUS },
				{ PARAM = STR_STAT, VALUE = 4, METHOD = STRAIGHT_BONUS, base = 4, delta = 1, delta_level = 1, delta_level_max = 50 },
			},
			SKILL_BONUS = { { id = "AABA", bonus_levels = 4 } },
			MAX_SLOTS = 2,
			frame_texture = "Armor\\BTNGauntletofThebesUpgraded.blp",
			legendary_effect = GetLegendaryEffect("galacos_trick_effect_Legendary"),
			special_description = "\"".. LOCALE_LIST[my_locale].ITEM_SPEC_DESCRIPTION_GALACOS_TRICK .."\"",
			soundpack = ITEM_SOUNDPACK[SOUNDPACK_HANDS_MID_ARMOR],
		})
		...
		ItemAddData('I04Z', {
			NAME    = LOCALE_LIST[my_locale].ITEM_NAME_THE_SERPENTFANG,
			TYPE    = ITEM_TYPE_WEAPON,
			SUBTYPE = DAGGER_WEAPON,
			QUALITY = UNIQUE_ITEM,
			ATTRIBUTE = POISON_ATTRIBUTE,
			...
			BONUS   = {
				{ PARAM = ATTACK_SPEED, VALUE = 10, METHOD = STRAIGHT_BONUS },
				{ PARAM = POISONING_DAMAGE_BOOST, VALUE = 25, METHOD = STRAIGHT_BONUS },
				{ PARAM = MOVING_SPEED, VALUE = 38, METHOD = STRAIGHT_BONUS },
			},
			MAX_SLOTS = 3,
			frame_texture = "Weapons\\BTNNature Short Blade.blp",
			model = "Items\\Almalexia_Scimitar.mdx",
			legendary_effect = GetLegendaryEffect("serpentfang_effect"),
			special_description = "\"".. LOCALE_LIST[my_locale].ITEM_SPEC_DESCRIPTION_SERPENTFANG .."\"",
			soundpack = { equip = "Sound\\daggers_poisoned_equip.wav", uneqip = "Sound\\dagger_unequip.wav", drop = "Sound\\smallmetalweapon.wav" }
		})

		ItemAddData('I050', {
			NAME    = LOCALE_LIST[my_locale].ITEM_NAME_CROWN_OF_HOLLOW_KING,
			TYPE    = ITEM_TYPE_ARMOR,
			SUBTYPE = HEAD_ARMOR,
			QUALITY = UNIQUE_ITEM,
			DEFENCE = 20,
			...
			level = 10,
			BONUS   = {
				{ PARAM = MINION_POWER, VALUE = 30, METHOD = STRAIGHT_BONUS },
				{ PARAM = INT_STAT, VALUE = 5, METHOD = STRAIGHT_BONUS, base = 5, delta = 1, delta_level = 5, delta_level_max = 10 },
				{ PARAM = ALL_RESIST, VALUE = 10, METHOD = STRAIGHT_BONUS },
			},
			MAX_SLOTS = 3,
			legendary_effect = GetLegendaryEffect("cohk_legendary"),
			frame_texture = "Armor\\BTNCrown of Dead Lord.blp",
			special_description = "\"".. LOCALE_LIST[my_locale].ITEM_SPEC_DESCRIPTION_CROWN_OF_HOLLOW_KING .."\"",
			soundpack = ITEM_SOUNDPACK[SOUNDPACK_HEAD_LIGHT_ARMOR],
		})

		ItemAddData('I051', {
			NAME    = LOCALE_LIST[my_locale].ITEM_NAME_DAWNWEAVER,
			TYPE    = ITEM_TYPE_WEAPON,
			SUBTYPE = BLUNT_WEAPON,
			...
			level = 10,
			BONUS   = {
				{ PARAM = DAMAGE_TO_CLOSE_ENEMIES, VALUE = 25, METHOD = STRAIGHT_BONUS },
				{ PARAM = CRIT_CHANCE, VALUE = 12, METHOD = STRAIGHT_BONUS },
				{ PARAM = HEALING_BONUS, VALUE = 15, METHOD = STRAIGHT_BONUS },
			},
			legendary_effect = GetLegendaryEffect("dawnweaver_effect_Legendary"),
			MAX_SLOTS = 3,
			frame_texture = "Weapons\\BTNMorningStarDivine64x64.blp",
			model = "Items\\Lion_Mace.mdx",
			special_description = "\"".. LOCALE_LIST[my_locale].ITEM_SPEC_DESCRIPTION_DAWNWEAVER .."\"",
			soundpack = ITEM_SOUNDPACK[SOUNDPACK_BLUNT]
		})
		...
		ItemAddData('I052', {
			NAME    		   = GetLocalString("Бронзовый Ключ", "Bronze Key"),
			TYPE    		   = ITEM_TYPE_KEY,
			QUALITY 		   = COMMON_ITEM,
			frame_texture      = "BTNBronzeKey.blp",
			item_description   = GetLocalString("Открывает сундук с сокровищами в подземельях", "Opens a treasure chest in dungeons"),
			soundpack = ITEM_SOUNDPACK[SOUNDPACK_KEY],
			cost = 250,
			usable = true,
			droppable = true,
			sellable = true,
		...
		ItemAddData('I053', {
			NAME    		   = GetLocalString("Серебрянный Ключ", "Silver Key"),
			TYPE    		   = ITEM_TYPE_KEY,
			QUALITY 		   = RARE_ITEM,
			frame_texture      = "MoonKey_TEX.blp",
			item_description   = GetLocalString("Открывает сундук с сокровищами в подземельях", "Opens a treasure chest in dungeons"),
			soundpack = ITEM_SOUNDPACK[SOUNDPACK_KEY],
			cost = 500,
			usable = true,
		...
		ItemAddData('I054', {
			NAME    		   = GetLocalString("Золотой Ключ", "Golden Key"),
			TYPE    		   = ITEM_TYPE_KEY,
			QUALITY 		   = MAGIC_ITEM,
			frame_texture      = "SunKey_TEX.blp",
			item_description   = GetLocalString("Открывает сундук с сокровищами в подземельях", "Opens a treasure chest in dungeons"),
			soundpack = ITEM_SOUNDPACK[SOUNDPACK_KEY],
			cost = 750,
			usable = true,
