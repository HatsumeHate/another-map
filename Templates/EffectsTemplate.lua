do
    ...
    function DefineEffectsData()
        ...
        --==========================================--
        NewEffectTemplate('effect_storm_front', {
            name = "storm_front effect",
            power_delta = 1,
            power_delta_level = 1,
            get_level_from_skill = "ASLF",
            single_attack_instance = true,
            global_crit = true,
            can_crit = true,
            is_direct = false,
            ...
            SFX_on_unit = "Abilities\\Spells\\Items\\AIlb\\AIlbSpecialArt.mdx",
            SFX_on_unit_point = "chest",
            sound = { { pack = { "Sounds\\Spells\\static1.wav", "Sounds\\Spells\\static2.wav", "Sounds\\Spells\\static3.wav", "Sounds\\Spells\\static4.wav" }, volume = 110, cutoff = 1500. } },
        ...
        --==========================================--
        NewEffectTemplate('effect_flamecrash_initial', {
            name = "flamecrash crash effect",
            power_delta = 2,
            power_delta_level = 1,
            attribute_bonus_delta = 1,
            attribute_bonus_delta_level = 5,
            get_level_from_skill = "AFCR",
            single_attack_instance = true,
            global_crit = true,
            can_crit = true,
            is_direct = true,
            ...
            attack_type = RANGE_ATTACK,
            attribute = FIRE_ATTRIBUTE,
            sound = { { pack = { "Sounds\\Spells\\sizzle1.wav", "Sounds\\Spells\\sizzle2.wav", "Sounds\\Spells\\sizzle3.wav" }, volume = 115, cutoff = 1500. } },
            sfx_pack = { on_unit = { { effect = "Abilities\\Spells\\Other\\ImmolationRed\\ImmolationRedDamage.mdx", point = "chest", duration = 1.  }, } },
            ...
            level = {
                [1] = {
                    ...
                    max_targets = 300,
                    applied_buff = {
                        [1] = { modificator = ADD_BUFF, buff_id = 'A04A', target_type = ON_ENEMY }
                    },
                }
            }
        })
        --==========================================--
        NewEffectTemplate('effect_flamecrash', {
            name = "flamecrash effect",
            power_delta = 2,
            power_delta_level = 1,
            attribute_bonus_delta = 1,
            attribute_bonus_delta_level = 5,
            ...
            attack_type = RANGE_ATTACK,
            attribute = FIRE_ATTRIBUTE,
            SFX_used = "Effect\\az_cwlava_t201.mdx",
            SFX_used_scale = 1.1,
            SFX_random_angle = true,
            sound = { { pack = { "Sounds\\Spells\\sizzle1.wav", "Sounds\\Spells\\sizzle2.wav", "Sounds\\Spells\\sizzle3.wav" }, volume = 115, cutoff = 1500. } },
            sfx_pack = { on_unit = { { effect = "Abilities\\Spells\\Other\\ImmolationRed\\ImmolationRedDamage.mdx", point = "chest", duration = 1.  }, } },
        ...
        NewEffectTemplate('effect_ring_of_fire_initial', {
            name = "fire nova effect",
            power_delta = 2,
            power_delta_level = 1,
            get_level_from_skill = "ASRF",
            single_attack_instance = true,
            can_crit = true,
            global_crit = true,
            is_direct = true,
            ...
            --SFX_used_scale = 1.,
            sfx_pack = { on_unit = { { effect = "Abilities\\Spells\\Other\\ImmolationRed\\ImmolationRedDamage.mdx", point = "chest", duration = 1.  }, } },
            sound_on_hit = { pack = { "Sounds\\Spells\\singe1.wav", "Sounds\\Spells\\singe2.wav", "Sounds\\Spells\\singe3.wav" }, volume = 115, cutoff = 1500. },
            --sound = { { pack = { "Sounds\\Spells\\FrostNova_Effect_1.wav", "Sounds\\Spells\\FrostNova_Effect_2.wav", "Sounds\\Spells\\FrostNova_Effect_3.wav", "Sounds\\Spells\\FrostNova_Effect_4.wav", "Sounds\\Spells\\FrostNova_Effect_5.wav" }, volume = 275, cutoff = 1800. } },
            --sound_on_hit = { pack = { "Sounds\\Spells\\frost_nova_hit_1.wav", "Sounds\\Spells\\frost_nova_hit_2.wav", "Sounds\\Spells\\frost_nova_hit_3.wav" }, volume = 100, cutoff = 1800. },
            ...
            level = {
                [1] = {
                    ...
                    max_targets = 300,
                    wave_speed = 900.,
                    applied_buff = { [1] = { modificator = ADD_BUFF, buff_id = 'A05J', target_type = ON_ENEMY } },
                }
            }

        })
        --==========================================--
        NewEffectTemplate('ring_of_fire_apply_effect', {
            name = "ring_of_fire_effect",
            get_level_from_skill = "ASRF",
            level = {
                [1] = {
                    area_of_effect = 125.,
                    max_targets = 300,
                    applied_buff = {
                        [1] = { modificator = ADD_BUFF, buff_id = 'A05J', target_type = ON_ENEMY }
                    },
                }
            }
        })
        --==========================================--
        NewEffectTemplate('ring_of_fire_damage_effect', {
            name = "ring_of_fire_damage_effect",
            power_delta = 1,
            power_delta_level = 1,
            get_level_from_skill = "ASRF",
            can_crit = false,
        ...
        NewEffectTemplate('effect_arcane_missile', {
            ...
            sound_on_hit = { pack = { "Sounds\\Spells\\Wizard_MagicMissile_Impact_01.wav", "Sounds\\Spells\\Wizard_MagicMissile_Impact_02.wav", "Sounds\\Spells\\Wizard_MagicMissile_Impact_03.wav", "Sounds\\Spells\\Wizard_MagicMissile_Impact_04.wav" }, volume = 120, cutoff = 1500. },
        ...
        --==========================================--
        NewEffectTemplate('fiery_rage_effect', {
            name = "fiery_rage effect",
            power_delta = 1,
            power_delta_level = 1,
            get_level_from_skill = "ABFR",
            single_attack_instance = true,
            can_crit = true,
            is_direct = false,
            is_sound = false,
        ...
        NewEffectTemplate('EEXC', {
            ...
            SFX_on_unit_point = "chest",
            SFX_on_unit_scale = 1.2,

            level = {
                [1] = {
                    power = 24,
                    attack_percent_bonus = 0.95,
                    area_of_effect = 235.,
                    angle_window  = 45,
                    max_targets = 300,
                }
        ...
        NewEffectTemplate('EFAA', {
            ...
            sfx_pack = { on_caster_restore = { { effect = "Effect\\BoilingBlood_effect.mdx", point = "origin", duration = 1.8  }, } },
        ...
        NewEffectTemplate('ECSL', {
            ...
            attack_type = MELEE_ATTACK,
            attribute = PHYSICAL_ATTRIBUTE,
            sfx_pack = { on_unit = { { effect = "Effect\\baojiang.mdx", point = "chest", scale = 1., duration = 0. }, } },
            sound_on_hit = {
        ...
        --==========================================--
        NewEffectTemplate('effect_lacerate', {
            name = "lacerate effect",
            power_delta = 2,
            power_delta_level = 1,
            get_level_from_skill = "ABLC",
            single_attack_instance = true,
            global_crit = true,
            can_crit = true,
            is_direct = true,
            ...
            level = {
                [1] = {
                    ...
                    max_targets = 300,
                    applied_buff = {
                        [1] = { modificator = ADD_BUFF, buff_id = 'A04P', target_type = ON_ENEMY }
                    },
                }
            }
        })
        NewEffectTemplate('sunder_effect', {
            name = "sunder effect",
            power_delta = 3,
            power_delta_level = 1,
            get_level_from_skill = "ABEQ",
            single_attack_instance = true,
            can_crit = true,
            global_crit = true,
            is_direct = false,
            ...
            attack_type = MELEE_ATTACK,
            attribute = PHYSICAL_ATTRIBUTE,
            SFX_used = "Effect\\chushou_by_wood_effect_earth_longzhituxi.mdx",
            SFX_used_scale = 1.,
            SFX_random_angle = true,
            sound = { { pack = { "Abilities\\Spells\\Human\\ThunderClap\\ThunderClapCaster.wav" }, volume = 127, cutoff = 1800. } },
            --sound_on_hit = { pack = { "Sounds\\Spells\\frost_nova_hit_1.wav", "Sounds\\Spells\\frost_nova_hit_2.wav", "Sounds\\Spells\\frost_nova_hit_3.wav" }, volume = 100, cutoff = 1800. },
            ...
            level = {
                [1] = {
                    ...
                    shake_distance = 1400.,
                    shake_duration = 0.6,
                    applied_buff = { [1] = { modificator = ADD_BUFF, buff_id = 'A04T', target_type = ON_ENEMY } },
                }
            }
        ...
        NewEffectTemplate('ECSP', {
            ...
            power_delta = 1,
            power_delta_level = 3,
            attack_percent_bonus_delta = 0.01,
            attack_percent_bonus_delta_level = 3,
            get_level_from_skill = "A006",
            can_crit = false,
            damage_type = DAMAGE_TYPE_PHYSICAL,
            attack_type = nil,
        ...
        NewEffectTemplate('effect_curved_strike', {
            ...
            attack_type = MELEE_ATTACK,
            attribute = PHYSICAL_ATTRIBUTE,
            sound_on_hit_trigger = {
                pack = { "Sounds\\Spells\\Impact_V3_01.wav", "Sounds\\Spells\\Impact_V3_02.wav", "Sounds\\Spells\\Impact_V3_03.wav", "Sounds\\Spells\\Impact_V3_04.wav" },
                volume = 110,
                cutoff = 1500.
            },
        ...
        NewEffectTemplate('effect_backstab', {
            ...
            attribute = PHYSICAL_ATTRIBUTE,
            sound_on_hit_trigger = {
                pack = { "Sounds\\Spells\\Ambush_Launch01.wav", "Sounds\\Spells\\Ambush_Launch02.wav", "Sounds\\Spells\\Ambush_Launch03.wav" },
                volume = 110,
                cutoff = 1500.
            },
        ...
        NewEffectTemplate('effect_eviscerate', {
            ...
            attribute = PHYSICAL_ATTRIBUTE,
            sound_on_hit_trigger = {
                pack = { "Sounds\\Spells\\Garrote_Launch_V3_01.wav", "Sounds\\Spells\\Garrote_Launch_V3_02.wav", "Sounds\\Spells\\Garrote_Launch_V3_03.wav" },
                volume = 110,
                cutoff = 1500.
            },
        ...
        NewEffectTemplate('effect_blade_of_darkness', {
            ...
            sound_on_hit = {
                pack = { "Sounds\\Spells\\ShadowDagger_Impact01.wav", "Sounds\\Spells\\ShadowDagger_Impact02.wav", "Sounds\\Spells\\ShadowDagger_Impact03.wav", "Sounds\\Spells\\ShadowDagger_Impact04.wav", "Sounds\\Spells\\ShadowDagger_Impact05.wav" },
                volume = 112,
                cutoff = 1500.
            },
        ...
        --==========================================--
        NewEffectTemplate('guardian_effect', {
            name = "guardian_effect",
            power_delta = 2,
            power_delta_level = 1,
            get_level_from_skill = "APGA",
            single_attack_instance = true,
            global_crit = true,
            can_crit = true,
            is_direct = true,
            ...
            level = {
                [1] = {
                    ...
                    max_targets = 300,
                    applied_buff = {
                        [1] = { modificator = INCREASE_BUFF_LEVEL, buff_id = 'A03J', target_type = ON_SELF },
                        [2] = { modificator = SET_BUFF_TIME, buff_id = 'A03J', target_type = ON_SELF, value = -1 }
                    },
                }
            }
        })
        --==========================================--
        NewEffectTemplate('retribution_effect', {
            name = "retribution_effect",
            power_delta = 1,
            power_delta_level = 1,
            get_level_from_skill = "APRT",
            can_crit = false,
            is_direct = false,
            damage_type = DAMAGE_TYPE_PHYSICAL,
            attack_type = MELEE_ATTACK,
        ...
        --==========================================--
        NewEffectTemplate('zeal_effect', {
            name = "zeal_effect",
            power_delta = 2,
            power_delta_level = 1,
            get_level_from_skill = "APZE",
            single_attack_instance = true,
            global_crit = true,
            can_crit = true,
            is_direct = true,
            ...
            level = {
                [1] = {
                    power = 25,
                    attack_percent_bonus = 1.12,
                    area_of_effect = 235.,
                    angle_window  = 55.,
                    max_targets = 300,
                    applied_buff = {
                        [1] = { modificator = INCREASE_BUFF_LEVEL, buff_id = 'A03L', target_type = ON_SELF },
                        [2] = { modificator = SET_BUFF_TIME, buff_id = 'A03L', target_type = ON_SELF, value = -1 }
                    },
                }
            }
        })
        --==========================================--
        NewEffectTemplate('shieldbash_effect', {
            name = "shieldbash_effect",
            power_delta = 3,
            power_delta_level = 1,
            get_level_from_skill = "APSB",
            single_attack_instance = true,
            global_crit = true,
            can_crit = true,
            is_direct = true,
            ...
            attack_type = MELEE_ATTACK,
            attribute = PHYSICAL_ATTRIBUTE,
            sound = { { pack = { "Sounds\\Spells\\Punish_Impact01.wav", "Sounds\\Spells\\Punish_Impact02.wav", "Sounds\\Spells\\Punish_Impact03.wav", "Sounds\\Spells\\Punish_Impact04.wav" },
                        volume = 115, cutoff = 1800. }
            },
            ...
            level = {
                [1] = {
                    ...
                    max_targets = 300,
                    applied_buff = {
                        [1] = { modificator = ADD_BUFF, buff_id = 'A03M', target_type = ON_ENEMY }
                    },
                }
            }
        })
        --==========================================--
        NewEffectTemplate('advance_effect', {
            name = "advance_effect",
            power_delta = 2,
            power_delta_level = 1,
            get_level_from_skill = "APCR",
            single_attack_instance = true,
            global_crit = true,
            can_crit = true,
            is_direct = true,
        ...
        --==========================================--
        NewEffectTemplate('chastise_effect', {
            name = "chastise_effect",
            power_delta = 3,
            power_delta_level = 1,
            get_level_from_skill = "APCH",
            single_attack_instance = true,
            global_crit = true,
            can_crit = true,
            is_direct = true,
        ...
        --==========================================--
        NewEffectTemplate('smite_effect', {
            name = "smite effect",
            power_delta = 2,
            power_delta_level = 1,
            get_level_from_skill = "APSM",
            single_attack_instance = true,
            global_crit = true,
            can_crit = true,
            is_direct = true,
            ...
            SFX_used = "Effect\\Flash.mdx",
            SFX_used_scale = 1.65,
            --SFX_used_matrix_scale = 1.4,
            SFX_random_angle = true,
            SFX_on_unit = "Effect\\model (342).mdx",
            SFX_on_unit_point = "chest",
            SFX_on_unit_duration = 0.234,
            SFX_on_unit_scale = 0.75,
            delay = 0.1,
            sound = { { pack = { "Sounds\\Spells\\smite_hit_1.wav", "Sounds\\Spells\\smite_hit_2.wav", "Sounds\\Spells\\smite_hit_3.wav" }, volume = 128, cutoff = 1800. } },
        ...
        --==========================================--
        NewEffectTemplate('fist_of_heavens_effect', {
            name = "fist_of_heavens effect",
            power_delta = 2,
            power_delta_level = 1,
            get_level_from_skill = "APFH",
            single_attack_instance = true,
            global_crit = true,
            can_crit = true,
            is_direct = true,
            ...
            attack_type = RANGE_ATTACK,
            attribute = HOLY_ATTRIBUTE,
            SFX_used = "Effect\\Stormfall Orange.mdx",
            SFX_random_angle = true,
            SFX_on_unit = "Abilities\\Spells\\Other\\Incinerate\\IncinerateBuff.mdx",
            SFX_on_unit_point = "chest",
            sound = { { pack = { "Sounds\\Spells\\foth_effect_1.wav", "Sounds\\Spells\\foth_effect_2.wav", "Sounds\\Spells\\foth_effect_3.wav", "Sounds\\Spells\\foth_effect_4.wav" }, volume = 128, cutoff = 1800. } },
        ...
        --==========================================--
        NewEffectTemplate('shield_throw_effect', {
            name = "shield throw effect",
            power_delta = 3,
            power_delta_level = 1,
            get_level_from_skill = "APSH",
            single_attack_instance = true,
            global_crit = true,
            can_crit = true,
            is_direct = true,
            ...
            SFX_on_unit = "Abilities\\Spells\\Other\\Incinerate\\IncinerateBuff.mdx",
            SFX_on_unit_point = "chest",
            sound = { { pack = { "Sounds\\Spells\\BlessedShield_Impact01.wav", "Sounds\\Spells\\BlessedShield_Impact02.wav", "Sounds\\Spells\\BlessedShield_Impact03.wav", "Sounds\\Spells\\BlessedShield_Impact04.wav", "Sounds\\Spells\\BlessedShield_Impact05.wav" },
                        volume = 115, cutoff = 1800. }
            },
        ...
        --==========================================--
        NewEffectTemplate('verdict_effect', {
            name = "verdict effect",
            power_delta = 2,
            power_delta_level = 1,
            get_level_from_skill = "APVA",
            single_attack_instance = true,
            global_crit = true,
            can_crit = true,
            is_direct = true,
            ...
            attack_type = RANGE_ATTACK,
            attribute = HOLY_ATTRIBUTE,
            SFX_used = "Effect\\Judgement NoHive.mdx",
            SFX_used_scale = 0.75,
            SFX_random_angle = true,
            SFX_on_unit = "Abilities\\Spells\\Other\\Incinerate\\IncinerateBuff.mdx",
            SFX_on_unit_point = "chest",
            delay = 0.9,
            timescale = 0.5,
            sound = { { pack = { "Sounds\\Spells\\verdict_impact_1.wav", "Sounds\\Spells\\verdict_impact_2.wav", "Sounds\\Spells\\verdict_impact_3.wav", "Sounds\\Spells\\verdict_impact_4.wav" }, volume = 128, cutoff = 1800. } },
            ...
            level = {
                [1] = {
                    ...
                    max_targets = 300,
                    applied_buff = {
                        [1] = { modificator = ADD_BUFF, buff_id = 'A03N', target_type = ON_ENEMY }
                    },
                }
            }
        })
        --==========================================--
        NewEffectTemplate('purify_effect', {
            name = "purify effect",
            power_delta = 2,
            power_delta_level = 1,
            get_level_from_skill = "APPR",
            single_attack_instance = true,
            global_crit = false,
            can_crit = true,
            is_direct = true,
        ...
        NewEffectTemplate('divine_wrath_effect', {
            name = "divine wrath effect",
            power_delta = 3,
            power_delta_level = 1,
            get_level_from_skill = "APDW",
            single_attack_instance = true,
            can_crit = true,
            global_crit = true,
            is_direct = true,
            ...
            attack_type = MELEE_ATTACK,
            attribute = HOLY_ATTRIBUTE,
            SFX_used = "Effect\\Empyrean Nova Classic.mdx",
            SFX_on_unit = "Abilities\\Spells\\Other\\Incinerate\\IncinerateBuff.mdx",
            SFX_on_unit_point = "chest",
        ...
        --==========================================--
        NewEffectTemplate('collective_punishment_effect', {
            name = "collective punishment effect",
            get_level_from_skill = "APCP",
            attribute = HOLY_ATTRIBUTE,
            --sound = { { pack = { "Sounds\\Spells\\lightning_hit_1.wav", "Sounds\\Spells\\lightning_hit_2.wav", "Sounds\\Spells\\lightning_hit_3.wav" }, volume = 128, cutoff = 1800. } },
        ...
        --==========================================--
        NewEffectTemplate('effect_renewal', {
            name = "effect_renewal",
            get_level_from_skill = "APRW",
            sfx_pack = { on_unit = { { effect = "Effect\\Heal.mdx", point = "origin", duration = 1. }, } },
            heal_amount_delta = 5,
            heal_amount_delta_level = 1,
            ...
            level = {
                [1] = {
                    ...
                    max_targets = 300,
                    applied_buff = {
                        [1] = { modificator = ADD_BUFF, buff_id = 'A03V', target_type = ON_ALLY }
                    },
                }
            }
        ...
        --==========================================--
        NewEffectTemplate('effect_renewal_periodic', {
            name = "effect_renewal",
            get_level_from_skill = "APRW",
            heal_amount_delta = 1,
            heal_amount_delta_level = 1,
        ...
        --==========================================--
        NewEffectTemplate('effect_sanctify_periodic', {
            name = "effect_sanctify_periodic",
            get_level_from_skill = "APSA",
            power_delta = 1,
            power_delta_level = 1,
            single_attack_instance = false,
            global_crit = false,
            can_crit = false,
            is_direct = false,
            damage_type = DAMAGE_TYPE_MAGICAL,
        ...
        --==========================================--
        NewEffectTemplate('holy_fire_periodic_effect', {
            name = "holy_fire_periodic_effect",
            can_crit = false,
            is_direct = false,
            damage_type = DAMAGE_TYPE_MAGICAL,
            attack_type = RANGE_ATTACK,
        ...
        --==========================================--
        NewEffectTemplate('effect_lightforged', {
            name = "effect_lightforged",
            single_attack_instance = false,
            global_crit = false,
            can_crit = true,
            is_direct = false,
        ...
        --==========================================--
        NewEffectTemplate('dawnweaver_effect', {
            name = "dawnweaver effect",
            single_attack_instance = true,
            global_crit = false,
            can_crit = false,
            is_direct = false,
        ...
        --==========================================--
        NewEffectTemplate('icebound_loop_effect', {
            name = "icebound loop effect",
            power_delta = 2,
            power_delta_level = 1,
            single_attack_instance = true,
            global_crit = true,
            ...
            attack_type = RANGE_ATTACK,
            attribute = ICE_ATTRIBUTE,
            SFX_used = "Effect\\Frost Spike.mdx",
            SFX_used_scale = 1.5,
            delay = 0.38,
            --SFX_used_matrix_scale = 1.4,
            SFX_random_angle = true,
            SFX_on_unit = "Abilities\\Spells\\Undead\\FrostArmor\\FrostArmorDamage.mdx",
            SFX_on_unit_point = "chest",
            sound = { { pack = { "Abilities\\Spells\\Other\\FrostBolt\\FrostBoltHit1.wav" }, volume = 128, cutoff = 1800. } },
        ...
        --==========================================--
        NewEffectTemplate('ashen_tonic_effect', {
            name = "ashen_tonic_effect",
            ...
            level = {
                [1] = {
                    max_targets  = 1,
                    applied_buff = {
                        [1] = { modificator = ADD_BUFF, buff_id = 'A05H', target_type = ON_SELF }
                    },
                }
            }
        })
        ...
        NewEffectTemplate('SOPT', {
            ...
            sound = { { pack = { "Sound\\magic_spell_earth_1_cast.wav" }, volume = 100, cutoff = 1600. } },
        ...
        --==========================================--
        NewEffectTemplate('bandit_rally_effect', {
            name = "bandit rally effect",
            SFX_used = "Effect\\Alterac_RoarCasterV3.mdx",
            SFX_random_angle = true,
            level = {
                [1] = {
                    area_of_effect = 650.,
                    max_targets = 300,
                    applied_buff = {
                        [1] = { modificator = ADD_BUFF, buff_id = 'A04Y', target_type = ON_ALLY }
                    },
                }
            }
        })
        --==========================================--
        NewEffectTemplate('arcane_ball_effect', {
            name = "arcane ball effect",
            get_level_from_wave = true,
            can_crit = true,
            is_direct = true,
            damage_type = DAMAGE_TYPE_MAGICAL,
            ...
            power_delta_level = 1,
            sound_on_hit = {
                pack = { "Abilities\\Spells\\Other\\BlackArrow\\TheBlackArrow.wav" },
                volume = 124, cutoff = 1600.
            },
            SFX_on_unit = "Abilities\\Spells\\Undead\\DeathandDecay\\DeathandDecayDamage.mdx",
            SFX_on_unit_point = "chest",
            hit_once_in = 0.5,
            ...
            level = {
                [1] = {
                    ...
                    max_targets = 300,
                    applied_buff = {
                        [1] = { modificator = ADD_BUFF, buff_id = 'A04Z', target_type = ON_ENEMY }
                    },
                }
            }
        })
        ...
        NewEffectTemplate('astral_barrage_effect', {
            ...
            SFX_used_scale = 0.8,
            sfx_pack = { on_caster = { { effect = "Abilities\\Spells\\Undead\\DeathandDecay\\DeathandDecayDamage.mdx", point = "chest" } } },
        ...
        --==========================================--
        NewEffectTemplate('lightning_breath_queen_effect', {
            name = "lightning_breath_queen_effect",
            power_delta = 1,
            power_delta_level = 1,
            get_level_from_wave = true,
            single_attack_instance = true,
        ...
        --==========================================--
        NewEffectTemplate('reanimated_spirit_effect', {
            name = "reanimated_spirit_effect",
            sfx_pack = { on_unit = { { effect = "Effect\\Heal Green.mdx", point = "origin", duration = 1. }, } },

            level = {
                [1] = {
                    heal_amount_max_hp = 0.1,
                    max_targets = 1,
                    applied_buff = {
                        [1] = { modificator = ADD_BUFF, buff_id = 'A05A', target_type = ON_ALLY }
                    },
                }
            }
        ...
        --==========================================--
        NewEffectTemplate('reanimated_bowskill_effect', {
            name = "reanimated_bowskil effect",
            get_level_from_wave = true,
            can_crit = true,
            is_direct = true,
            is_sound = true,
            ...
            power_delta_level = 1,
            hit_once_in = 1.,
            sound_on_hit = { { pack = { "Sound\\Impact\\sword1.wav", "Sound\\Impact\\sword2.wav", "Sound\\Impact\\sword3.wav", "Sound\\Impact\\sword4.wav" }, volume = 126, cutoff = 1500. } },
        ...
        --==========================================--
        NewEffectTemplate('andariel_poison_pool_effect', {
            name = "andariel poison pool effect",
            get_level_from_wave = true,
            can_crit = false,
            is_direct = false,
            is_sound = false,
            ...
            level = {
                [1] = {
                    ...
                    hit_once_in = 0.49,
                    applied_buff = {
                        [1] = { modificator = INCREASE_BUFF_LEVEL, buff_id = 'A040', target_type = ON_ENEMY },
                        [2] = { modificator = SET_BUFF_TIME, buff_id = 'A040', target_type = ON_ENEMY, value = -1 }
                    },
                }
            }
        })
        ...
        --==========================================--
        NewEffectTemplate('goat_fire_effect', {
            name = "goat fire effect",
            get_level_from_wave = true,
            can_crit = false,
            is_direct = false,
            is_sound = false,
            ...
            sfx_pack = { on_unit = { { effect = "Effect\\BuildingDmgBlast016.mdx", point = "origin", scale = 0.8 }, } },
        ...
        --==========================================--
        NewEffectTemplate('goat_lightning_effect', {
            name = "goat lightning effect",
            get_level_from_wave = true,
            can_crit = false,
            is_direct = false,
            is_sound = false,
            ...
            power_delta = 2,
            power_delta_level = 1,
            sound = { { pack = { "Sounds\\Spells\\static1.wav", "Sounds\\Spells\\static2.wav", "Sounds\\Spells\\static3.wav", "Sounds\\Spells\\static4.wav" }, volume = 114, cutoff = 1500. } },
            sfx_pack = { on_unit = { { effect = "Abilities\\Spells\\Orc\\Purge\\PurgeBuffTarget.mdx", point = "origin", duration = 1.1, scale = 0.9 }, } },
        ...
        --==========================================--
        NewEffectTemplate('decay_magical_weapon_effect', {
            name = "decay weapon effect",
            can_crit = false,
            is_direct = false,
            damage_type = DAMAGE_TYPE_MAGICAL,
            attack_type = nil,
        ...
        --==========================================--
        NewEffectTemplate('siren_fire_effect', {
            name = "siren_fire_ effect",
            can_crit = true,
            is_direct = true,
            damage_type = DAMAGE_TYPE_PHYSICAL,
            attack_type = RANGE_ATTACK,
        ...
        --==========================================--
        NewEffectTemplate('meat_golem_meat_effect', {
            name = "meat golem meat effect",
            get_level_from_wave = true,
            power_delta = 3,
            power_delta_level = 1,
            can_crit = true,
        ...
        --==========================================--
        NewEffectTemplate('meat_golem_regen_effect', {
            name = "meat golem meat effect",

            level = {
                [1] = {
                    applied_buff = {
                        [1] = { modificator = ADD_BUFF, buff_id = 'A03I', target_type = ON_SELF }
                    },
                }
            }
        })
        --==========================================--
        NewEffectTemplate('meat_golem_regen_period_effect', {
            name = "meat_golem_regen_effect",
            sfx_pack = { on_caster_restore = { { effect = "Abilities\\Spells\\Undead\\VampiricAura\\VampiricAuraTarget.mdx", point = "origin", duration = 1.833  }, } },
        ...
        --==========================================--
        NewEffectTemplate('belial_rain_effect', {
            name = "belial rain effect",
            get_level_from_wave = true,
            power_delta = 3,
            power_delta_level = 1,
            can_crit = true,
            ...
            attack_type = RANGE_ATTACK,
            attribute = POISON_ATTRIBUTE,
            SFX_used = "Effect\\Rain of Fire Fel.mdx",
            SFX_random_angle = true,
            sound = {
                { pack = { "Abilities\\Spells\\Demon\\RainOfFire\\RainOfFireTarget1.wav", "Abilities\\Spells\\Demon\\RainOfFire\\RainOfFireTarget2.wav", "Abilities\\Spells\\Demon\\RainOfFire\\RainOfFireTarget3.wav" },
                  volume = 80, cutoff = 1500., delay = 1.25 }
            ...
            delay = 1.25,
            sfx_pack = { on_unit = { { effect = "Abilities\\Spells\\NightElf\\Immolation\\ImmolationDamage.mdx", point = "chest", duration = 1. }, } },
        ...
        --==========================================--
        NewEffectTemplate('belial_fel_effect', {
            name = "belial fel flame effect",
            get_level_from_wave = true,
            power_delta = 3,
            power_delta_level = 1,
            can_crit = true,
        ...
        --==========================================--
        NewEffectTemplate('belial_fear_effect', {
            name = "belial fear effect",
            SFX_used = "Effect\\LaughingSkull_RoarCaster.mdx",
            SFX_random_angle = true,
            ...
            level = {
                [1] = {
                    ...
                    area_of_effect = 300.,
                    applied_buff = {
                        [1] = { modificator = ADD_BUFF, buff_id = 'A043', target_type = ON_ENEMY }
                    },
                }
            }
        })
        --==========================================--
        NewEffectTemplate('belial_doubt_effect', {
            name = "belial doubt effect",
            SFX_used = "Effect\\Falling Light.mdx",
            SFX_random_angle = true,
            SFX_bonus_z = 5.,
            delay = 1.6,
            timescale = 0.6,
            ...
            level = {
                [1] = {
                    ...
                    wave_speed = 700.,
                    applied_buff = {
                        [1] = { modificator = ADD_BUFF, buff_id = 'A046', target_type = ON_ENEMY }
                    },
                }
            }
        })
        --==========================================--
        NewEffectTemplate('sboss_necrotic_effect', {
            name = "execution effect",
            power_delta = 2,
            power_delta_level = 2,
            get_level_from_wave = true,
            ...
            attack_type = MELEE_ATTACK,
            attribute = PHYSICAL_ATTRIBUTE,
            SFX_on_unit = "Effect\\Ephemeral Cut Avocado.mdx",
            SFX_on_unit_point = "chest",
            SFX_on_unit_scale = 1.25,
            ...
            level = {
                [1] = {
                    ...
                    max_targets = 300,
                    applied_buff = {
                        [1] = { modificator = ADD_BUFF, buff_id = 'A048', target_type = ON_ENEMY }
                    },
                }
            }
        })
        --==========================================--
        NewEffectTemplate('effect_duriel_poison_aura', {
            name = "effect_duriel_poison_aura",
            get_level_from_wave = false,
            can_crit = false,
            is_direct = false,
            is_sound = false,
            ...
            level = {
                [1] = {
                    applied_buff = {
                        [1] = { modificator = INCREASE_BUFF_LEVEL, buff_id = 'A04U', target_type = ON_ENEMY },
                        [2] = { modificator = SET_BUFF_TIME, buff_id = 'A04U', target_type = ON_ENEMY, value = -1 }
                    },
                }
            }
        })
        --==========================================--
        NewEffectTemplate('effect_duriel_periodic', {
            name = "effect_duriel_periodic",
            get_level_from_wave = true,
            power_delta = 1,
            power_delta_level = 1,
            can_crit = false,
        ...
        --==========================================--
        NewEffectTemplate('duriel_stun_effect', {
            name = "duriel_stun_effect",
            power_delta = 2,
            power_delta_level = 2,
            get_level_from_wave = true,
            single_attack_instance = true,
            ...
            level = {
                [1] = {
                    ...
                    max_targets = 300,
                    applied_buff = {
                        [1] = { modificator = ADD_BUFF, buff_id = 'A04W', target_type = ON_ENEMY }
                    },
                }
            }
        })
        --==========================================--
        NewEffectTemplate('duruel_holy_freeze_effect', {
            name = "duruel_holy_freeze_effect",
            get_level_from_wave = true,
            can_crit = true,
            is_direct = true,
            damage_type = DAMAGE_TYPE_PHYSICAL,
            ...
            power_delta_level = 1,
            sound = { { pack = { "Sounds\\Spells\\ice_crack_1.wav", "Sounds\\Spells\\ice_crack_2.wav", "Sounds\\Spells\\ice_crack_3.wav" }, volume = 122, cutoff = 1800. } },
            sound_on_hit = { pack = { "Abilities\\Spells\\Other\\FrostBolt\\FrostBoltHit1.wav" }, volume = 128, cutoff = 1600. },
            SFX_on_unit = "Abilities\\Spells\\Items\\AIob\\AIobSpecialArt.mdx",
            SFX_on_unit_point = "chest",
            SFX_used = "Effect\\FrostNova_Blue.mdx",
            SFX_random_angle = true,
            SFX_lifetime = 1.5,
            delay = 1.5,
            ...
            level = {
                [1] = {
                    ...
                    area_of_effect = 225.,
                    applied_buff = {
                        [1] = { modificator = ADD_BUFF, buff_id = 'A051', target_type = ON_ENEMY }
                    },
                }
            }
        })
